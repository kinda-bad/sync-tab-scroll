...
describe('beatAtTick', () => {
  ...
  it('counts 4/4 beats within bar 1 at a steady tempo', () => {
  ...
  it('rolls into bar 2 at the bar boundary', () => {
    const score = fourFour();
  ...
  it('counts to the actual numerator in a non-4/4 bar', () => {
  ...
  it('clamps a negative (count-in region) tick to bar 1 beat 1 with bar 1 beat count', () => {
  ...
  it('clamps a tick past the end of the score to the last bar last beat', () => {
    const score = fourFour();
...
describe('beatDurationMs', () => {
  ...
  it('scales with the bar duration in non-quarter denominators (7/8)', () => {
