...
- [x] F001 Audio-output-latency ticker offset (originally `feedback-lyrics-timing-tiro-c741.md` F001) remains unconfirmed after `tasks-1619-1185.md`/`plan-1619-2026-07-17-39c6.md`'s T014 research task. Findings from that pass:
