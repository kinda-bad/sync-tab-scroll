...
Why: onboarding currently requires reading multiple artifacts/scripts to piece together dev setup and the .gp ingestion workflow; a single authoritative README section would shorten that.
