...
- [x] T020 [artifacts: ui] Implement the Session-tab host control and Playback View de-emphasis rendering to make T019 pass. Implements `host-set-early-stop-point-for`.
